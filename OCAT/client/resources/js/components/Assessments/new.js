        ...
        <div className="col-12 col-md-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-row align-items-center mb-1">
              ...
              {errors.catName, errors.catDateOfBirth  && <p  style={mystyle}>Required*</p>}
              </div>
            </div>
            </div>
            <div className="form-row align-items-center mb-1">
                 <div className="col-auto">
                <h5>Instrument</h5>
                <input  type="text" name="instrument" value="Cat Behavior Instrument" disabled readOnly="readOnly" ref={register()}/>
              </div>
              </div>
            ...
            <div className="form-row align-items-center mb-3">
              ...
              {errors.response1 && <p  style={mystyle}>Required*</p>}
              </div>
            </div>
            ...
            <div className="form-row align-items-center mb-3">
              ...
              {errors.response2 && <p  style={mystyle}>Required*</p>}
              </div>
            </div>
            ...
            <div className="form-row align-items-center mb-3">
              ...
              {errors.response3 && <p  style={mystyle}>Required*</p>}
              </div>
            </div>
            ...
            <div className="form-row align-items-center mb-3">
              ...
              {errors.response4 && <p  style={mystyle}>Required*</p>}
              </div>
            </div>
            ...
            <div className="form-row align-items-center mb-2">
              <div className="col-auto">
                ...
                {errors.response5 && <p style={mystyle}>Required*</p>}
              </div>
            </div>
